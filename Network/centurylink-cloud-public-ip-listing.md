...
A:  All IPs in CenturyLink datacenters worldwide are registered to a mailing address in the United States via Internap.  As such, most GeoIP services will show the IPs as being in the US, rather than in the country the datacenter is housed in.  This is an effect of our relationship with our registrar and cannot be changed either per customer or per datacenter.
